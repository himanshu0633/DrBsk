...
const OrderPage = () => {
  const orders = [
    { id: 1, orderId: '#1001', customer: 'John Doe', date: '2025-04-26', status: 'Shipped' },
    { id: 2, orderId: '#1002', customer: 'Jane Smith', date: '2025-04-27', status: 'Processing' },
    { id: 3, orderId: '#1003', customer: 'Mike Johnson', date: '2025-04-28', status: 'Delivered' }
  ];
